...
from module.mol_dit_feat import mol_dit_feat_model
import torch
...
if __name__ == "__main__":
    ...
    train_dataset = bulk_org_info_Dataset(config, smiles_dot=True)
    ...
    for batch in tqdm(train_loader):
        ...
        smiles_list = smiles_list + smiles_string
    seen = set()
    unique_strings = []
    ...
    df = pd.DataFrame(unique_strings, columns=["smiles"])
    output_path = "unique_smiles_items.csv"
